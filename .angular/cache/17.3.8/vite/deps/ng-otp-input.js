...
_NgOtpInputComponent.ɵfac = function NgOtpInputComponent_Factory(t) {
  return new (t || _NgOtpInputComponent)(ɵɵdirectiveInject(DOCUMENT));
};
...
(() => {
  ...
  <div class="n-o-c">\r
    <ng-container *ngFor="let item of controlKeys;let i=index;let last=last">\r
      ...
      (keyup)="onKeyUp($event,i)" (input)="onInput($event,i)" (keydown)="onKeyDown($event,i)" [ngClass]="{'error-input': (config?.showError && formCtrl?.invalid && (formCtrl?.dirty || formCtrl?.touched))}">\r
